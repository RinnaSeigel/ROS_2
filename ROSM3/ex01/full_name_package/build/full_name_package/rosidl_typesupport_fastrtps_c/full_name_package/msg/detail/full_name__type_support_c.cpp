...
#include "full_name_package/msg/detail/full_name__rosidl_typesupport_fastrtps_c.h"
...
using _FullName__ros_msg_type = full_name_package__msg__FullName;
  ...
  void * untyped_ros_message)
{
  ...
  _FullName__ros_msg_type * ros_message = static_cast<_FullName__ros_msg_type *>(untyped_ros_message);
  // Field name: last_name
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_full_name_package__msg__FullName(
  const void * untyped_ros_message,
...
static uint32_t _FullName__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_full_name_package__msg__FullName(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_full_name_package
size_t max_serialized_size_full_name_package__msg__FullName(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = full_name_package__msg__FullName;
    is_plain =
      (
...
static size_t _FullName__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_full_name_package__msg__FullName(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_package, msg, FullName)() {

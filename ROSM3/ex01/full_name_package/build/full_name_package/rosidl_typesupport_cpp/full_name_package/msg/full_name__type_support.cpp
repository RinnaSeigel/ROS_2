...
static const _FullName_type_support_symbol_names_t _FullName_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, full_name_package, msg, FullName)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, full_name_package, msg, FullName)),
  }
};
...
{
  return &::full_name_package::msg::rosidl_typesupport_cpp::FullName_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, full_name_package, msg, FullName)() {
  return get_message_type_support_handle<full_name_package::msg::FullName>();
}

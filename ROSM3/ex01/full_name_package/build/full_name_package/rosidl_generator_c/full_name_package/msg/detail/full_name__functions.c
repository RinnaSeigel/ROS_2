...
full_name_package__msg__FullName__init(full_name_package__msg__FullName * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->last_name)) {
    full_name_package__msg__FullName__fini(msg);
    return false;
  }
  // name
...
full_name_package__msg__FullName__create()
{
  ...
  full_name_package__msg__FullName * msg = (full_name_package__msg__FullName *)allocator.allocate(sizeof(full_name_package__msg__FullName), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(full_name_package__msg__FullName));
  bool success = full_name_package__msg__FullName__init(msg);
  if (!success) {
...
full_name_package__msg__FullName__Sequence__init(full_name_package__msg__FullName__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_package__msg__FullName * data = NULL;

  if (size) {
    data = (full_name_package__msg__FullName *)allocator.zero_allocate(size, sizeof(full_name_package__msg__FullName), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = full_name_package__msg__FullName__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        full_name_package__msg__FullName__fini(&data[i - 1]);
      }
...
full_name_package__msg__FullName__Sequence__fini(full_name_package__msg__FullName__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      full_name_package__msg__FullName__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  full_name_package__msg__FullName__Sequence * array = (full_name_package__msg__FullName__Sequence *)allocator.allocate(sizeof(full_name_package__msg__FullName__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = full_name_package__msg__FullName__Sequence__init(array, size);
  if (!success) {
...
full_name_package__msg__FullName__Sequence__destroy(full_name_package__msg__FullName__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    full_name_package__msg__FullName__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
full_name_package__msg__FullName__Sequence__are_equal(const full_name_package__msg__FullName__Sequence * lhs, const full_name_package__msg__FullName__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!full_name_package__msg__FullName__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  full_name_package__msg__FullName__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(full_name_package__msg__FullName);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    full_name_package__msg__FullName * data =
      (full_name_package__msg__FullName *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!full_name_package__msg__FullName__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          full_name_package__msg__FullName__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!full_name_package__msg__FullName__copy(

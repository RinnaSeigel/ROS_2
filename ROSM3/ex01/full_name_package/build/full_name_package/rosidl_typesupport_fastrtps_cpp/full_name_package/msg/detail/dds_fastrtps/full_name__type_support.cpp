...
#include "full_name_package/msg/detail/full_name__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = full_name_package::msg::FullName;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const full_name_package::msg::FullName *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<full_name_package::msg::FullName *>(
    untyped_ros_message);
...
{
  return &full_name_package::msg::typesupport_fastrtps_cpp::_FullName__handle;
}

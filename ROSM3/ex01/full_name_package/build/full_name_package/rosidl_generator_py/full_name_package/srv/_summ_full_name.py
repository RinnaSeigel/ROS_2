...
class Metaclass_SummFullName_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('full_name_package')
        except ImportError:
            import logging
            import traceback
...
class SummFullName_Request(metaclass=Metaclass_SummFullName_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.middle_name = kwargs.get('middle_name', str())
    ...
    def middle_name(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'middle_name' field must be of type 'str'"
...
class Metaclass_SummFullName(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'full_name_package.srv.SummFullName')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from full_name_package.srv import _summ_full_name
...
class SummFullName(metaclass=Metaclass_SummFullName):
    from full_name_package.srv._summ_full_name import SummFullName_Request as Request
    from full_name_package.srv._summ_full_name import SummFullName_Response as Response

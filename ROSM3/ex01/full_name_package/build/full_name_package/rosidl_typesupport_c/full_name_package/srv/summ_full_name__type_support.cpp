...
static const _SummFullName_Request_type_support_symbol_names_t _SummFullName_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_package, srv, SummFullName_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, full_name_package, srv, SummFullName_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, full_name_package, srv, SummFullName_Request)() {
  return &::full_name_package::srv::rosidl_typesupport_c::SummFullName_Request_message_type_support_handle;
}
...
static const _SummFullName_Response_type_support_symbol_names_t _SummFullName_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_package, srv, SummFullName_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, full_name_package, srv, SummFullName_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, full_name_package, srv, SummFullName_Response)() {
  return &::full_name_package::srv::rosidl_typesupport_c::SummFullName_Response_message_type_support_handle;
}
...
static const _SummFullName_type_support_symbol_names_t _SummFullName_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_package, srv, SummFullName)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, full_name_package, srv, SummFullName)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, full_name_package, srv, SummFullName)() {
  return &::full_name_package::srv::rosidl_typesupport_c::SummFullName_service_type_support_handle;
}
